...
trainingFiles = 'fd_sai_hand.mat,fd_sam_hand.mat,fd_udit_hand.mat,fd_sai_colored_bg.mat,fd_sam_colored_bg.mat,fd_sai_colored_bg_2.mat,fd_sai_colored_bg_3.mat,fd_sai_new.mat,fd_sai_new_2.mat';
trainingLabelFiles = 'Y_sai_hand.mat,Y_sam_hand.mat,Y_udit_hand.mat,Y_sai_colored_bg.mat,Y_sam_colored_bg.mat,Y_sai_colored_bg_2.mat,Y_sai_colored_bg_3.mat,Y_sai_new.mat,Y_sai_new_2.mat';
%trainingFiles = 'fd_sai_colored_bg_2.mat';
%trainingLabelFiles = 'Y_sai_colored_bg_2.mat';
...
for i = 2 : length(trainFiles)
    data = load(strcat(folderName, trainFiles{i}));
    d = data.global_samples_fd;
    labels = load(strcat(folderName, trainLabelFiles{i}));
    l = labels.Y;  
    all_data = [all_data,d];
